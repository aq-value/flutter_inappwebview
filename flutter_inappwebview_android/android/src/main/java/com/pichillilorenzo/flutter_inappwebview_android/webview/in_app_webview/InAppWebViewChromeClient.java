...
//    }
    ...
    //    private Boolean acceptsImagesOnly(String[] types) {
//        String[] mimeTypes = getAcceptedMimeType(types);
//        return (types.length==1 && arrayContainsString(mimeTypes, "image"));
//    }
    private Boolean acceptsImages(String[] types) {
        String[] mimeTypes = getAcceptedMimeType(types);
